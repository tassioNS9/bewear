...
export const createCheckoutSession = async (
  ...
  // Se não estiver, retorna um erro de autorização
  ...
  // Verifica se o pedido existe e pertence ao usuário autenticado
  ...
  // Busca os itens do pedido para criar a sessão de checkout
  // no Stripe
